	...
	?>
		<header>
			...
			<address >
				...
				<p>Lê Duẩn,<br>Thành Phố Vinh,<br>Nghệ An.</p>
				<p>0123456789</p>
			</address>
			<span><img alt="" src="assets/img/nhom2.JPG"></span>
		</header>
		<article>
			<h1>Tên</h1>
			<address >
			...
			<table class="inventory">
				...
				<tbody>
					<tr>
						...
						<td><span ><?php  echo $type_of_room;?></span><span data-prefix>Đồng</span></td>
					
						<td><span><?php echo $ttot; ?></span><span data-prefix>Đồng</span></td>
					</tr>
					<tr>
						<td><span ><?php echo $bed; ?>  Bàn </span></td>
						<td><span ><?php echo $days; ?></span></td>
						
						
						<td><span><?php echo $btot; ?></span><span data-prefix>Đồng</span></td>
					</tr>
					<tr>
						<td><span ><?php echo $meal; ?> Người </span></td>
						<td><span ><?php echo $days; ?></span></td>
						<!-- <td><span data-prefix>$</span><span ><?php  echo $type_of_meal?></span></td> -->
					
						<td><span><?php echo $mepr; ?></span><span data-prefix>Đồng</span></td>
					</tr>
				</tbody>
			</table>
			...
			<table class="balance">
				<tr>
					...
					<td><span><?php echo $fintot; ?></span><span data-prefix>Đồng</span></td>
				</tr>
				<tr>
					<th><span >Số tiền đã trả</span></th>
					<td><span >0</span><span data-prefix>Đồng</span></td>
				</tr>
				<tr>
		...
		<aside>
			...
			<div >
				<p align="center">Email : nhom2@gmail.com || Web : Nhóm 2 || Phone : 0123456789 </p>
			</div>
		</aside>
	</body>
</html>
