        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="messages.php"><i class="fa fa-desktop"></i> Tin Tức</a>
                    </li>
					<li>
                        <a href="roombook.php"><i class="fa fa-bar-chart-o"></i>Đặt Lịch</a>
                    </li>
                    <li>
            ...
            <div id="page-inner">
			 <div class="row">
			   ...
			   ?>
                ...
                <div class="col-md-12">
                    <div class="jumbotron">
                        <h3>Gửi thư cho người theo dõi</h3>
						<?php
						...
						<div class="panel-body">
							...
							{	
								...
								{
									echo '<script>alert("Tin Mới Đã Được Thêm Vào") </script>' ;
