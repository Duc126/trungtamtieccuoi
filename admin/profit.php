        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a  href="messages.php"><i class="fa fa-desktop"></i> TIN MỚI</a>
                    </li>
					<li>
                        <a href="roombook.php"><i class="fa fa-bar-chart-o"></i>LỊCH KHÁCH ĐẶT</a>
                    </li>
                    <li>
                    ...
                    <li>
					 ...
					 <li>
                        <a class="active-menu" href="profit.php"><i class="fa fa-qrcode"></i> Thống Kê</a>
                    </li>
