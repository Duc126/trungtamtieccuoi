                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            TÌNH TRẠNG <small>ĐẶT LỊCH </small>
                        </h1>
                    </div>
                </div>
                                    ...
                                    <div class="panel panel-primary">
                                            ...
                                            <h4 class="panel-title">
                                                <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">
                                                    <button class="btn btn-default" type="button">
                                                        ĐẶT LỊCH MỚI <span class="badge"><?php echo $c; ?></span>
                                                    </button>
                                                </a>
                                            </h4>
                                        </div>
                                        <div id="collapseTwo" class="panel-collapse in" style="height: auto;">
                                            <div class="panel-body">
												...
												<th><a href='roombook.php?rid=" . $trow['id'] . " ' class='btn btn-primary'>Phê Duyệt</a></th>
												</tr>";
                                                                        }
                                                                    }
                                                                    ?>
                                            ...
                                            <h4 class="panel-title">
                                                <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" class="collapsed">
                                                    <button class="btn btn-primary" type="button">
                                                        Hội Trường Đã Được Đặt <span class="badge"><?php echo $r; ?></span>
                                                    </button>
                                        ...
                                        <div id="collapseThree" class="panel-collapse collapse">
                                            <div class="panel-body">
												...
												<th>" . $crow['approval'] . "</th>
                                                        ...
                                                        <a href="messages.php" class="btn btn-primary">Phê Duyệt</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
