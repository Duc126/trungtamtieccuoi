        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a  href="settings.php"><i class="fa fa-dashboard"></i>Hội Trường Có Sẵn</a>
                    </li>
					<li>
                        <a  class="active-menu" href="room.php"><i class="fa fa-plus-circle"></i>Thêm Hội Trường</a>
                    </li>
                    <li>
                        <a  href="roomdel.php"><i class="fa fa-desktop"></i>Xóa Hội Trường</a>
                    </li>
						...
						<form name="form" method="post">
							...
							<?php
							 ...
							 if(isset($_POST['add']))
							 {
										...
										if($data[0] > 1) {
											echo "<script type='text/javascript'> alert('Hội trường đã có trong hệ thống')</script>";
										...
										{
										 echo '<script>alert("Hội trường mới đã được thêm vào") </script>' ;
										}else {
											echo '<script>alert("Xin lỗi ! Kiểm tra hệ thống") </script>' ;
										}
							 }
							}
